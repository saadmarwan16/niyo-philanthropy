...
const MonthlyDonation: FunctionComponent<MonthlyDonationProps> = () => {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {donationAmount === "Other" && (
          <div className="w-full mt-2 form-control">
            ...
            <input
              ...
              className={`custom-input !w-24 !bg-base-300 ${
        ...
        <div className="mt-6">
          <p className="mb-2 font-semibold text-primary">
            Will help provide {watch("amount") * 8} books each month
          </p>
          <p className="mt-2 font-semibold text-primary">
            Will help provide {watch("amount") * 5} meals each month
          </p>
          <p className="mt-2 font-semibold text-primary">
            Will help provide {watch("amount") * 1} sanitary pads each month
          </p>
        </div>
